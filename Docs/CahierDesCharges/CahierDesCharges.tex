...
\indent L'ergonomie de l'application est également un motif d'utilisation, le visuel étant la première impression laissée auprès de l'utilisateur. Le choix des préférences mentionné dans la partie précédente doit donc permettre à l'utilisateur d'effectuer des réglages qui filtrent les données affichées afin de ne pas surcharger l'écran d'information inintéressantes pour l'utilisateur.\\
...
L'application doit répondre à un réel besoin des étudiants en matière d'information. Le présent cahier des charges étant basé sur les attentes des utilisateurs recueillies lors d'interviews préalables, il se peut qu'une partie des attentes du public visé soient passées inaperçues dans les nombreux sondages effectués. Un comité de pilotage interne via les membres de l'association du Grand Cercle se réunira afin de limiter ces risques. Néanmoins, il faudra assurer une maintenance de l'application, guidée par les réactions des utilisateurs. Cette maintenance sera rendue possible par des documents de conception dûment complétés, ainsi que par un code commenté. 
