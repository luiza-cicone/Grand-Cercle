...
\indent L'utilisateur sera également sensible à la synchronisation des données de l'application avec celles du site. Les informations présentées seront donc changées en temps réel, afin de créer un certain dynamisme de la vie étudiante de Grenoble INP auprès des étudiants.
