...
Nous avons remarqué que la communication par rapport au Grand Cercle, mais aussi aux cercles et autres associations affiliés est parfois difficile.

{\bf Scénario 1} 

Alexandre est nouveau étudiant à l'Ense3 et il veut participer a un événement organisé par le BDE Phelma. etc..

\subsection{Modèle de l'utilisateur}

Nous avons ciblé plusieurs types d'utilisateurs...

\newpage


\section{Vision de la solution}
Nous avons choisi de développer une application smartphone visant à améliorer la communication du Grand Cercle et des Cercles.
\newpage
