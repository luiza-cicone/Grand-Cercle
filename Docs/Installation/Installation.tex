...
Pour effectuer la maintenance de l'application iOS, il est nécessaire de posséder un mac munit du logiciel Xcode, disponible sur l'Apple store. Il est nécessaire d'installer les différentes versions de Xcode pour disposer des différents simulateurs iOS nous permettant de tester sur les différentes versions de l'OS.
