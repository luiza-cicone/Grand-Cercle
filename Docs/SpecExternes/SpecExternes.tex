...
\subsubsection{Pages événements}
Dans l'affichage liste des événements (Fig. \ref{even_liste}) il y a les événements groupés par date, à partir du jour présent. 
